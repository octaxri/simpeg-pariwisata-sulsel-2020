...
class Crud extends CI_Model {
    ...
    public function gdl($t,$w,$l,$f){return $this->db->where($w)->limit($l,$f)->get($t)->row();}
    public function gdlo($t,$w,$l,$f,$o){return $this->db->where($w)->limit($l,$f)->order_by($o)->get($t)->row();}
    ...
    public function qa($q){return $this->db->query($q)->num_rows();}
    public function qr($q){return $this->db->query($q)->result();}
    public function ua($t,$d){$this->db->update($t,$d);}
    public function lq(){$this->db->last_query();}
}
