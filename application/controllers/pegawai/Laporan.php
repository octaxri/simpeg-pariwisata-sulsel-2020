...
class Laporan extends MY_Controller {
    ...
    public function riwayatHidup()
    {
        ...
        'isi'       => 'pegawai/laporan/riwayat_hidup');
    ...
    public function cetak($id = NULL)
    {
        ...
        'isi'       => 'pegawai/laporan/cetak_riwayat');
        $this->load->view('pegawai/laporan/cetak_riwayat', $data);
    }
    ...
    public function unitKerja()
    {
        ...
        'data_skpd' => $data_skpd,
        'isi'       => 'pegawai/laporan/unit_kerja');
        $this->load->view('pegawai/_layout/wrapper', $data);
    }
    ...
    public function namaPejabat()
    {
        ...
        'isi'       => 'pegawai/laporan/nama_pejabat');
        $this->load->view('pegawai/_layout/wrapper', $data);
    }
    ...
    public function jenisKelamin()
    {
        ...
        'isi'       => 'pegawai/laporan/jenis_kelamin');
        $this->load->view('pegawai/_layout/wrapper', $data);
    }
    ...
    public function golongan()
    {
        ...
        'isi'       => 'pegawai/laporan/rekap_golongan');
        $this->load->view('pegawai/_layout/wrapper', $data);
    }
    ...
    public function riwayat_template(
        ...
        <div class="panel">
            <div class="panel-heading right">
                <a type="" href="'.pegawai_url("laporan/Cetak/".$data_pegawai->nip).'" class="btn btn-default"><i class="fa fa-print"></i>Cetak</a>
            </div>
