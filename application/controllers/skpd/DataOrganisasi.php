...
class DataOrganisasi extends MY_Controller {
    ...
    public function index(){
        ...
        $data = array(  'title'     => 'Struktur Organisasi '. $this->session->fullname,
        ...
        'isi'       => 'skpd/data_organisasi/beranda');
    ...
    public function get_data_nip_parent()
    {
        ...
        $c = $this->db->select('nip, nama_lengkap')->where('satuan_kerja', $b)->get('data_pegawai')->result();
    ...
    public function struktur_organisasi()
    {
        ...
        'satker' => $this->db->where('nama_satker', $this->session->fullname)->get('data_satker')->row('id_satker'),
        'table' => 'data_organisasi',
        'isi'       => 'skpd/data_organisasi/struktur_organisasi');
        $this->load->view('skpd/_layout/wrapper', $data);
    }
