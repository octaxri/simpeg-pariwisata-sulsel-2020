...
<script type="text/javascript">
    ...
    $.ajax({
        type: 'POST',
        url: '<?=skpd_url("Laporan/FilterAjax/")?>',
        data: {
          identifier: $('#identifier').val()
            ...
            if (response.success) {
                // console.log(response.data);
                 var item = response.data_pegawai;
                      var item_alamat = response.data_alamat;
                      var item_keteranganlainnya = response.data_keteranganlainnya;
                      var item_keteranganbadan = response.data_keteranganbadan;
                      if (item.gambar != '') {
                        item.gambar = '<?=upload_url('fotopegawai')?>'+item.gambar;
                      }else{
                        item.gambar = '<?=upload_url('fotopegawai')?>no_image.jpg';
                      }
                        var b = moment(item.tanggal_lahir),
                            a = moment(),
              ...
              <div class="panel-heading">
                ...
                <div class="right">
                  <a type="" href="<?=skpd_url('laporan/Cetak/')?>`+item.nip+`" class="btn btn-default"><i class="fa fa-print"></i>Cetak</a>
                </div>
              </div>
              <div class="panel-body">
                <div class="col-md-12">
