            ...
            <div class="profile-right">
                <h4 class="heading">Informasi Kepegawaian
                    <div class="pull-right">
                        <a href="<?=skpd_url('DataPegawai/edit/').$data_pegawai->nip?>" class="btn btn-success btn-xs"><span><i class="fa fa-edit"></i></span>Ubah Data</a>
                        <!--<a href="<?=skpd_url('Laporan/cetak/').$data_pegawai->nip?>" target="_blank" class="btn btn-primary btn-xs"><span><i class="fa fa-print"></i></span>Cetak</a>-->
                    </div>
                </h4>
                        ...
                        <div class="col-md-6">
                            <table class="standard-table" style="text-align: left;" width="100%" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="data-item" data-id="">
                                    <td>TMT Jabatan</td>
                                    <td width="10px" style="color: #848484;">:</td>
                                    <td><i><?=date('d F Y',strtotime(str_replace('/', '-', $data_pegawai->tmt_jabatan)))?></i></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="angkakredit">
                        <div class="table-responsive">
                            ...
                            <div class="col-md-5 col-md-offset-4 form-group pull-right">
                                ...
                                <div class="col-sm-4">
                                    <input id="tot_kpen_angkakredit" type="text" value="" class="form-control" readonly="">
                                </div>
                            ...
                            <div class="col-md-5 col-md-offset-4 form-group pull-right">
                                ...
                                <div class="col-sm-4">
                                    <input id="tot_ku_angkakredit" type="text" value="" class="form-control" readonly="">
                                </div>
