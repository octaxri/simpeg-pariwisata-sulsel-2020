...
<head>
	...
	<!--end::Layout Skins -->
	<link rel="shortcut icon" href="assets/media/logosimpel.ico">
	<style>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor " style="">
               <div class="layer-image">
                  <img class="bg-image" src="assets/media/samalona.jpg" alt="" style="">
                  <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                     <div class="kt-login__container">
                        <div class="kt-login__logo">
                           <a href="#">
                              <img width="300" src="assets/media/logo-sulsel-stroke-putih.png">
                           </a>
                        </div>
