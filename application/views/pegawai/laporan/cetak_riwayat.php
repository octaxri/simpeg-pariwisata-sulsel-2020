            ...
            <div class="col-md-12"> 
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td width="30%" style="font-weight: bold">NIP</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->nip?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Gelar Depan</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->gelar_depan?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Gelar Belakang</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->gelar_belakang?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Tanggal Lahir</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->tanggal_lahir?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Tempat Lahir</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->tempat_lahir?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Usia</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$usia?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Jenis Kelamin</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->jenis_kelamin?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Status Pernikahan</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_pegawai->status_pernikahan?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">Agama</td>
                            <td width="2%">:</td>
                        ...
                        <tr>
                            <td width="30%" style="font-weight: bold">No. Telepon</td>
                            <td width="2%">:</td>
                            <td width="68%"><?=$data_alamat->telepon?></td>
                        </tr>
                        <tr>
                            <td width="30%" style="font-weight: bold">No. HP</td>
                            <td width="2%">:</td>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <table class="table table-bordered">
                    <tbody>
                    <tr>
                        <td width="30%" style="font-weight: bold">NIK</td>
                        <td width="2%">:</td>
                        <td width="70%"><?=$data_keteranganlainnya->no_ktp?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Golongan Darah</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=$data_pegawai->golongan_darah?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">No. NPWP</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=$data_keteranganlainnya->no_npwp?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">No. SKCK</td>
                        <td width="2%">:</td>
                        <td>-</td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">No. Taspen</td>
                        <td width="2%">:</td>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <table class="table table-bordered table-responsive">
                    <tbody>
                    <tr>
                        <td width="30%" style="font-weight: bold">Nomor SK Pengangkatan CPNS</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_cpns) ? $data_cpns->no_sk : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Pejabat yang Menetapkan</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_cpns) ? $data_cpns->pejabat : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Pangkat/Golongan/Ruang</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_cpns) ? $data_cpns->pangkat : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">TMT CPNS</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_cpns) ? $data_cpns->tanggal_sk : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Masa Kerja</td>
                        <td width="2%">:</td>
                        <td width="68%">-</td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">TMT Melaksanakan Tugas</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_cpns) ? $data_cpns->tanggal_tmt : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">No. STTPP (Prajabatan)  </td>
                        <td width="2%">:</td>
                        <td width="68%">-</td>
                    </tr>
                    </tbody>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <td width="30%" style="font-weight: bold">Tanggal SK PNS</td>
                        <td width="2%">:</td>
                    ...
                    <tr>
                        <td width="30%" style="font-weight: bold">TMT PNS</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_pns) ? $data_pns->tanggal_tmt : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Sumpah / Janji PNS</td>
                        <td width="2%">:</td>
                        <td width="68%"><?=(($data_pns) ? $data_pns->sumpah : "-")?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Pengambil Sumpah</td>
                        <td width="2%">:</td>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <td width="30%" style="font-weight: bold">TMT Pangkat/Golongan/Ruang</td>
                        <td width="2%">:</td>
                        <td><?=$data_pegawai->tmt_jenis_pangkat?></td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Tanggal SK</td>
                        <td width="2%">:</td>
                        <td>-</td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Nomor SK</td>
                        <td width="2%">:</td>
                        <td>-</td>
                    </tr>
                    <tr>
                        <td width="30%" style="font-weight: bold">Penandatangan SK</td>
                        <td width="2%">:</td>
                        <td>-</td>
                    </tr>
                    </tbody>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <td width="30%" style="font-weight: bold">Penandatangani SK</td>
                        <td width="2%">:</td>
...
<table style="width: 100%;" class="text-center">
	<tr>
		...
		<td width="50%">
			<p>Makassar, <?php echo strftime('%e %B %Y'); ?></p>
			<br>
			<br>
			<br>
			<p style="text-decoration: underline; font-weight: bold;"><?=$data_pegawai->nama_lengkap?></p>
		</td>
	</tr>
</table>
