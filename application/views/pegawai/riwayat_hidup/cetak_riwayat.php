...
<body onload='window.print();' style="font-family: calibri; margin: 10%; margin-top:5%">
    <center>
        ...
        <br>
        <img src="http://demo.shinzotech.com/simpeg2/images/pegawai/230019454.jpg" class="img-thumbnail loaded-image" style="width:15%">    
    </center>
    <h4>DATA DIRI</h4>
    <table >
        <tbody>
    ...
    <table class="table">
        <tbody>
            <tr>
                <td width="300px">Status Kepegawaian</td>
                <td width="100px">:</td>
                <td width="600px">PNS</td>
            </tr>
            <tr>
