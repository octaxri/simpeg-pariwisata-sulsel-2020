...
<head>
    ...
    <?= ($modul == 'referensi') ? '<link rel="stylesheet" href="'.assets_url().'vendor/x-editable/bootstrap3-editable/css/bootstrap-editable.css">' : '' ?>
    <?= ($modul == 'referensi') ? '<link rel="stylesheet" href="'.assets_url().'vendor/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css">' : '' ?>
    <!-- MAIN CSS -->
    ...
    <?= ($modul == 'referensi') ? '<script src="'.assets_url().'vendor/x-editable/bootstrap3-editable/js/bootstrap-editable.js"></script> ' : ''; ?>
    ...
    <?= ($modul == 'referensi') ? '<script src="'.assets_url().'vendor/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js"></script>' : '' ?>
    <?= ($modul == 'referensi') ? '<script src="'.assets_url().'vendor/x-editable/inputs-ext/typeaheadjs/typeaheadjs.js"></script>' : '' ?>
