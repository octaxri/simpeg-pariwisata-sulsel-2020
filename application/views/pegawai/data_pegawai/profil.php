...
<div class="panel panel-headline">
    <div class="panel-heading">
        <center>
        <h4 class="panel-title">MASNUNAH, S.H., M.H.</h4>
        <p>NIP : 19601207 198703 2 001</p>
        </center>
    </div>
    ...
    <hr>
        <div class="row">
            <div class="col-md-2 text-center">
                <img src="http://demo.shinzotech.com/simpeg2/images/pegawai/230019454.jpg" class="img-thumbnail loaded-image" style="width:100%"> </div>
                <div class="col-md-4">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Mahasiswa</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_anak" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Mahasiswa</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_ortu" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>yahuuu</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_pendidikan" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>23-08-44</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_jabatan" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>23-08-44</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_mutasi" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>23-08-44</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_golongan" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>13 03 39</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_diklat_struktural" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>13 03 39</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_diklat_fungsional" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>13 03 39</td>
                                                    <td align="center">
                                                        <a data-toggle="modal" data-target="#edit_diklat_teknis" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                        <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                                    </td>
                                                </tr>
                                            </tbody>
      ...
      <div class="modal-body">
        <form class="form-horizontal">
          ...
          <div class="col-md-3 col-md-offset-5">
            <a  class="btn btn-primary btn-sm" href="profil_lengkap.html"><i class="glyphicon glyphicon-floppy-save"></i>  Simpan </a>
          </div>
          </div>
        </form>
      </div>
