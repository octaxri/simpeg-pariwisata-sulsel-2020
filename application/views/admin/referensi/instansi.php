  ...
  <div class="col-md-12">
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        <a data-toggle="modal" data-target="#tambah_satker_modal" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i>&nbsp;Tambah Data Bidang/Bagian</a>
        <hr>
        <div class="row">
          <div class="col-md-12">
      ...
      <div class="modal-dialog "><!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" align="center">Tambah Data Bidang/Bagian</h4>
          </div>
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group ">
                <div class="col-md-3 col-md-offset-5">
                  <a  class="btn btn-primary btn-sm " onclick="refrensidata_send('satker')"><i class="glyphicon glyphicon-floppy-save"></i>  Simpan </a>
                </div>
              </div>
            </form>
          </div>
    ...
    <div id="edit_satker_modal" class="modal fade " role="dialog">
      <div class="modal-dialog "><!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title" align="center">Edit Data Bidang/Bagian</h4>
          </div>
          <div class="modal-body">
            <form class="form-horizontal">
              <div class="form-group">
              ...
              <div class="form-group ">
                <div class="col-md-3 col-md-offset-5">
                  <a  class="btn btn-primary btn-sm" onclick="editData_send('satker');"><i class="glyphicon glyphicon-edit"></i>  Simpan Perubahan </a>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <div class="form-group ">
                <div class="col-md-3 col-md-offset-5">
                  <a  class="btn btn-primary btn-sm " onclick="refrensidata_send('unit')"><i class="glyphicon glyphicon-floppy-save"></i>  Simpan </a>
                </div>
              </div>
            </form>
          </div>
    ...
    <div id="daftar_unit" class="modal fade " role="dialog">
      <div class="modal-dialog modal-lg"><!-- Modal content-->
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table id="tbl_daftar-unit" style="min-width: 100%;" class="table table-bordered ">
              <thead>
                <tr>
                  <th width="50px;">No.</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="swal2-select form-control" id="value_selsatker" style="display: block;">
                    <option value="" disabled="">Pilih Bidang/Bagian</option>
             ...
             <div class="form-group ">
              <div class="col-md-3 col-md-offset-5">
                <a  class="btn btn-primary btn-sm " onclick="editData_send('unit');"><i class="glyphicon glyphicon-floppy-save"></i>  Simpan </a>
              </div>
            </div>
          </form>
        </div>
    ...
    function refrensidata_send(method) {
      switch (method) {
        ...
        $.ajax({
          ...
          if (response.success) {
            $('#tbl_satker').append('<tr data-id="' + response.data.id_satker + '"><td class="text-center">.</td><td>' + response.data.nama_satker + '</td><td ><a  data-toggle="modal" data-target="#edit_satker_modal" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a><a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a></td></tr>');
            $('.error_satker').html('');
            $('#tambah_satker').val('');
        ...
        $.ajax({
          ...
          if (response.success) {
            $('#tbl_unit').append('<tr data-id="' + response.data.id_unit + '"><td class="text-center">.</td><td>' + response.data.nama_satker + '</td><td>' + response.data.nama_unit + '</td><td><a  data-toggle="modal" data-target="#edit_unit_modal" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a><a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a></td></tr>');
            $('.error_unit').html('');
            $('#tambah_unit').val('');
            $('#tambah_unit').val('');
