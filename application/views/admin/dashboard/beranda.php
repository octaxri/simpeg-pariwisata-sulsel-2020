    ...
    $(document).ready(function(){
        $(function() {
            ...
            var data_eselon = {
                ...
                series: [
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'I.a'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'I.b'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'II.a'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'II.b'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'III.a'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'III.b'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'IV.a'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'IV.b'))?>,
                    <?=$this->crud->cw('data_pegawai', array('eselon' => 'Non-Eselon'))?>
                ]
            };
            ...
            var data_jeniskelamin = {
                labels: ['Pria', 'Wanita'],
                series: [
                <?=$this->crud->cw('data_pegawai', array('jenis_kelamin' => 'Pria'))?>,
                <?=$this->crud->cw('data_pegawai', array('jenis_kelamin' => 'Wanita'))?>
            ]};
