    ...
    <div class="col-md-12">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="datatable-data-export" style="min-width: 100%;" class="table table-bordered table-sorting table-hover no-footer">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Lengkap</th>
                            ...
                            <tbody>
                                <?php $i= 1; foreach ($data_pegawai as $data_pegawai): ?>
                                    <tr data-nip="<?=$data_pegawai->nip?>">
                                        ...
                                        <td align="center">
                                            <a href="<?=admin_url('DataPegawai/edit/').$data_pegawai->nip?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                            <a class="btn btn-danger btn-xs" onclick="hapusData('<?=$data_pegawai->nip?>');"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                        </td>
                                    </tr>
                                <?php $i++; endforeach ?>
                            </tbody>
    ...
    function hapusData(nip) {
        ...
        function(isConfirm){
          if (isConfirm) {
            $.ajax({
                type: 'POST',
                url: '<?=admin_url('referensiAjax/hapusData/')?>'+nip
