    ...
    <div class="modal-dialog "><!-- Modal content-->
        ...
        <script type="text/javascript">
            function add_data() {
               ...
               $.ajax({
                  type: 'POST',
                  url: '<?=admin_url('MigrasiPegawai/tambah_mutasi')?>',
             ...
             function editSend(id) {
               $.ajax({
                  type: 'POST',
                  url: '<?=admin_url('MigrasiPegawai/tambah_mutasi')?>'+id,
                  data: {
            ...
            function hapusData(id,type) {
              ...
              function(isConfirm){
                if (isConfirm) {
                  $.ajax({
                      type: 'POST',
                      url: '<?=admin_url('MigrasiPegawai/tambah_mutasi')?>'+id+'/'+type
                    }).done(function(response) {
                      if (response.success) {
            ...
            function editData(id){
                $.post("<?=admin_url('MigrasiPegawai/getDataAjax/')?>"+id+'/'+'mutasi', function(result){
                      if (result.success) {
