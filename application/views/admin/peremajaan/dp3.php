                    ...
                    <tbody>
                        <?php if ($riwayat_dp3_notverified != NULL): ?>
                            ...
                            <tr class="data-itemriwayatdp3" data-id="<?=$riwayat_dp3_notverified->id_riwayat?>">
                                ...
                                <td align="center">
                                    <a style="" onclick="isVerified('yes', '<?=$riwayat_dp3_notverified->id_riwayat?>')" class="btn btn-primary btn-xs"><i class="fa fa-check-circle"></i>Ya</a>
                                    <a style="" onclick="isVerified('no','<?=$riwayat_dp3_notverified->id_riwayat?>');" class="btn btn-danger btn-xs"><i class="fa fa-times-circle"></i>Tidak</a>
                               </td>
                           </tr>
                           <?php $i++; endforeach;?>
                       <?php endif;?>
