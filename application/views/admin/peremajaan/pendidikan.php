          ...
          <tbody >
            <?php if ($riwayat_pendidikan_notverified != NULL): ?>
              ...
              <tr class="data-itemriwayatpendidikan" data-id="<?=$riwayat_pendidikan_notverified->id_riwayat?>">
                ...
                <td data-tingkat style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->tingkat?></td>
                <td data-namaprodi style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->nama_prodi?></td>
                <td data-namajurusan style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->nama_jurusan?></td>
                <td data-namasekolah style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->nama_sekolah?></td>
                <td data-noijazah style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->no_ijazah?></td>
                <td data-tahunlulus style="font-size: 0.8em;"='<?=$riwayat_pendidikan_notverified->id_riwayat?>'><?=$riwayat_pendidikan_notverified->tahun_lulus?></td>
                <td style="font-size: 0.8em;"><?=$riwayat_pendidikan_notverified->admin?></td>
                <td>
                    <a data-toggle="modal" data-target="#edit_pendidikan" onclick="editData('pendidikan',<?=$riwayat_pendidikan_notverified->id_riwayat?>);" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                    <a onclick="hapusRiwayat('pendidikan',<?=$riwayat_pendidikan_notverified->id_riwayat?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                </td>
              </tr>
              <?php $i++; endforeach ?>
            <?php endif ?>
          ...
          <tbody >
            <?php if ($riwayat_pendidikan_verified != NULL): ?>
              ...
              <tr class="data-itemriwayatpendidikan" data-id="<?=$riwayat_pendidikan_verified->id_riwayat?>">
                ...
                <td data-tingkat style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->tingkat?></td>
                <td data-namaprodi style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->nama_prodi?></td>
                <td data-namajurusan style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->nama_jurusan?></td>
                <td data-namasekolah style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->nama_sekolah?></td>
                <td data-noijazah style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->no_ijazah?></td>
                <td data-tahunlulus style="font-size: 0.8em;"='<?=$riwayat_pendidikan_verified->id_riwayat?>'><?=$riwayat_pendidikan_verified->tahun_lulus?></td>
