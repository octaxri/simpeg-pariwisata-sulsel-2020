<div class="row">
  <div class="col-md-12">
    ...
    <!--<div class="panel">
      <div class="panel-heading panel-danger">
        <h3 class="panel-title font-white">Verifikasi Data Diklat Teknis</h3>
      </div>
      <div class="panel-body">
       <table id="tbl_riwayat_diklat_teknis" style="min-width: 100%;" class="table table-bordered table-sorting table-hover datatable-Exnormal dataTable no-footer">
        ...
        <tbody>
          <?php if ($riwayat_teknis_notverified != NULL): ?>
            <?php $i = 1; ?>
            <?php foreach ($riwayat_teknis_notverified as $riwayat_teknis_notverified): ?>
              <?php if ($riwayat_teknis_notverified->jenis_diklat == 'teknis'): ?>
                <tr class="data-itemriwayatdiklat" data-id="<?=$riwayat_teknis_notverified->id_riwayat?>">
                  <td><?=$i?></td>
                  <td><?=$riwayat_teknis_notverified->nip?></td>
                  <td><?=$riwayat_teknis_notverified->nama_lengkap?></td>
                  <td><?=$riwayat_teknis_notverified->nama_diklat?></td>
                  <td><?=$riwayat_teknis_notverified->jumlah_jam?></td>
                  <td><?=$riwayat_teknis_notverified->penyelenggara?></td>
                  <td><?=$riwayat_teknis_notverified->tempat?></td>
                  <td><?=$riwayat_teknis_notverified->angkatan?></td>
                  <td><?=$riwayat_teknis_notverified->tahun?></td>
                  <td><?=$riwayat_teknis_notverified->no_sttp?></td>
                  <td><?=$riwayat_teknis_notverified->tanggal_sttp?></td>
                  <td align="center">
                    <a onclick="editData('diklat',<?=$riwayat_teknis_notverified->id_riwayat?>);" data-toggle="modal" data-target="#edit_diklat_teknis" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                    <a onclick="hapusRiwayat('diklat',<?=$riwayat_teknis_notverified->id_riwayat?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                  </td>
                  <td style="display: none;"><?=$riwayat_teknis_notverified->jenis_diklat?></td>
                </tr>
                <?php $i++; ?>
              <?php endif ?>
            <?php endforeach ?>
  ...
  <div class="panel">
    <div class="panel-heading">
      <h3 class="panel-title">Riwayat Diklat Teknis</h3>

    </div>
    <div class="panel-body">
        <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambah_diklat_teknis"><i class="glyphicon glyphicon-plus"></i> Tambah Data Diklat Teknis</a>
        <hr>
     <table id="tbl_riwayat_diklat_teknis" style="min-width: 100%;" class="table table-bordered table-sorting table-hover datatable-Exnormal dataTable no-footer">
      <thead>
        <tr >
...
<!--          <th style="display: none;">Jenis Diklat</th>-->
      ...
      <tbody>
        <?php if ($riwayat_teknis_verified != NULL): ?>
          <?php $i = 1; ?>
          <?php foreach ($riwayat_teknis_verified as $riwayat_teknis_verified): ?>
            <?php if ($riwayat_teknis_verified->jenis_diklat == 'teknis'): ?>
              <tr class="data-itemriwayatdiklat" data-id="<?=$riwayat_teknis_verified->id_riwayat?>">
                <td><?=$i?></td>
                <td><?=$riwayat_teknis_verified->nip?></td>
                <td><?=$riwayat_teknis_verified->nama_lengkap?></td>
                <td><?=$riwayat_teknis_verified->nama_diklat?></td>
                <td><?=$riwayat_teknis_verified->jumlah_jam?></td>
                <td><?=$riwayat_teknis_verified->penyelenggara?></td>
                <td><?=$riwayat_teknis_verified->tempat?></td>
                <td><?=$riwayat_teknis_verified->angkatan?></td>
                <td><?=$riwayat_teknis_verified->tahun?></td>
                ...
                <!--<td style="display: none;"><?=$riwayat_teknis_verified->jenis_diklat?></td>-->
              </tr>
              <?php $i++; ?>
            <?php endif ?>
          <?php endforeach ?>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="angkatan_teknis" class="form-control" placeholder="Isi dengan Angka">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                        <div class="col-md-3 col-md-offset-5">
                            <a  class="btn btn-primary btn-sm" onclick="addData_send('riwayat_diklat_teknis','teknis')"><i class="glyphicon glyphicon-floppy-save"></i>  Simpan </a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="bahan" class="col-sm-3 control-label">Angkatan</label>
                        <div class="col-sm-9">
                            <input type="number" id="edit_angkatan_teknis" class="form-control" placeholder="Isi dengan Angka">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bahan" class="col-sm-3 control-label">Tahun</label>
...
<script>
  ...
  function editData_send(model){
    switch (model) {
      ...
      $.ajax({
        ...
        data: {
          nama_diklat: $('#edit_nama_teknis').val(),
          jumlah_jam: $('#edit_jumlah_jam_teknis').val(),
          penyelenggara: $('#edit_penyelenggara_teknis').val(),
          tempat: $('#edit_tempat_teknis').val(),
          angkatan: $('#edit_angkatan_teknis').val(),
          tahun: $('#edit_tahun_teknis').val(),
          no_sttp: $('#edit_no_sttp_teknis').val(),
          tanggal_sttp: $('#edit_tanggal_sttp_teknis').val(),
  ...
  function editData(model,id){
    switch (model) {
      ...
      $('#edit_nama_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(3)").text());
      $('#edit_jumlah_jam_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(4)").text());
      $('#edit_penyelenggara_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(5)").text());
      $('#edit_tempat_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(6)").text());
      $('#edit_angkatan_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(7)").text());
      $('#edit_tahun_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(8)").text());
      $('#edit_no_sttp_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(9)").text());
      $('#edit_tanggal_sttp_teknis').val($(".data-itemriwayatdiklat[data-id='" + id + "']>td:eq(10)").text());
      idGlob = id;
      break;
      default:
  ...
  $('#tambah_diklat_teknis').on('hidden.bs.modal', function () {
      location.reload();
  });
