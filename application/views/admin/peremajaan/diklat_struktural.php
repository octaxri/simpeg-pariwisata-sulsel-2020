<div class="row">
            ...
            <?php foreach ($riwayat_struktural_notverified as $riwayat_struktural_notverified): ?>
              <?php if ($riwayat_struktural_notverified->jenis_diklat == 'struktural'): ?>
                <tr class="data-itemriwayatdiklat" data-id="<?=$riwayat_struktural_notverified->id_riwayat?>">
                  ...
                  <td align="center">
                    <a onclick="editData('diklat',<?=$riwayat_struktural_notverified->id_riwayat?>);" data-toggle="modal" data-target="#edit_diklat_struktural" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                    <a onclick="hapusRiwayat('diklat',<?=$riwayat_struktural_notverified->id_riwayat?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                  </td>
  ...
  <div class="panel">
    ...
    <div class="panel-body">
        <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambah_diklat_struktural"><i class="glyphicon glyphicon-plus"></i> Tambah Data Diklat Struktural</a>
        <hr>
     <table id="tbl_riwayat_diklat_struktural" style="min-width: 100%;" class="table table-bordered table-sorting table-hover datatable-Exnormal dataTable no-footer">
      <thead>
        <tr >
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="angkatan_struktural" class="form-control" placeholder="Isi dengan Angka">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="bahan" class="col-sm-3 control-label">Angkatan</label>
                        <div class="col-sm-9">
                            <input type="number" id="edit_angkatan_struktural" class="form-control" placeholder="Isi dengan Angka">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bahan" class="col-sm-3 control-label">Tahun</label>
                    ...
                    <div class="form-group">
                        <label for="bahan" type="date" class="col-sm-3 control-label">Nomor STTP</label>
                        <div class="col-sm-9">
                            <input type="text" id="edit_no_sttp_struktural" class="form-control" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bahan" type="date" class="col-sm-3 control-label">Tanggal STTP</label>
...
<script>
  ...
  $('#tambah_diklat_struktural').on('hidden.bs.modal', function () {
      location.reload();
  });
