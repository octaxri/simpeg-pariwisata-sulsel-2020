                ...
                <?php if ($riwayat_kursus_notverified != NULL): ?>
                    <?php $i=1; foreach ($riwayat_kursus_notverified as $riwayat_kursus_notverified): ?>
                        <tr class="data-itemriwayatkursus" data-id="<?=$riwayat_kursus_notverified->id_riwayat?>">
                            ...
                            <td>
                                <a data-toggle="modal" data-target="#edit_kursus" onclick="editData('kursus',<?=$riwayat_kursus_notverified->id_riwayat?>);" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                <a href="#" onclick="hapusRiwayat('kursus',<?=$riwayat_kursus_notverified->id_riwayat?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
