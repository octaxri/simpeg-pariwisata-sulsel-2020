                    ...
                    <tbody>
                       <?php if ($riwayat_penghargaan_notverified != NULL): ?>
                            ...
                            <tr class="data-itemriwayatpenghargaan" data-id="<?=$riwayat_penghargaan_notverified->id_riwayat?>">
                                ...
                                <td>
                                    <a data-toggle="modal" data-target="#edit_penghargaan" onclick="editData('penghargaan',<?=$riwayat_penghargaan_notverified->id_riwayat?>);" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                    <a onclick="hapusRiwayat('penghargaan',<?=$riwayat_penghargaan_notverified->id_riwayat?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                            <?php $i++; endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="no_surat_penghargaan" type="text" class="form-control" >
                        </div>
                    </div>
                    <div class="form-group">
