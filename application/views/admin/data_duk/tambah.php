          ...
          <div class="tab-content no-padding">
           <div class="tab-pane fade in active" id="tab1">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label">Jenj. Pendidikan &nbsp; <strong style="color: red;">(*)</strong></label>
                <div class="col-md-8">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="control-label col-md-8 col-md-offset-2">Upload Foto Pegawai  (Ukuran 3x4, Portrait/Square) &nbsp; <strong style="color: red;">(*)</strong></label><br>
            ...
            <div class="col-md-6">
              ...
              <div class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <textarea rows="3" style="resize: none; text-transform: uppercase;" name="instansi_induk" class="form-control" readonly>Dinas Kebudayaan dan Kepariwisataan Provinsi Sulawesi Selatan</textarea>
                  </div>
                </div>
                <div class="form-group">
