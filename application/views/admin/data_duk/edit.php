  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        ...
        <?=validation_errors();?>
        <?=form_open_multipart(admin_url('DataPegawai/editAjax/'.$data_pegawai->nip), array('class' => 'form-horizontal', 'id' => 'editpegawai_form'))?>
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <select name="jenis_pangkat" class="form-control" required>
                    <option value="">-Pangkat/Golongan/Ruang-</option>
                    <?php foreach ($data_golongan as $data_golongan): ?>
                      <option <?=($data_pegawai->jenis_pangkat) == ($data_golongan->nama_pangkat . ' - '. $data_golongan->nama_golongan . ' ' . $data_golongan->nama_ruang) ? 'selected' : ''?> value="<?=$data_golongan->nama_pangkat . ' - ' .$data_golongan->nama_golongan. ' ' .$data_golongan->nama_ruang?>"><?=$data_golongan->nama_pangkat . ' - ' .$data_golongan->nama_golongan. ' ' .$data_golongan->nama_ruang?></option>
                    <?php endforeach ?>
                  </select>
          ...
          <div class="col-md-12">
            <hr>
            <div class="alert alert-info"><i class="fa fa-info-circle"></i> DATA PEKERJAAN (Saat Ini)</div>
          </div>
          <div class="col-md-6">
            <div class="form-horizontal">
              <div class="form-group">
          ...
          <div class="col-md-12">
            <hr>
            <center>
              <button class="btn btn-primary btn-sm" id="submit" type="submit" ><i class="fa fa-save"></i>SIMPAN PERUBAHAN</button>
