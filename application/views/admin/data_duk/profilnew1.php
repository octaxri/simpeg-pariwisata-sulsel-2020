                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group ">
                        <div class="col-md-3 col-md-offset-5">
                            <a  class="btn btn-primary btn-sm" onclick="profilAjax_send('<?=$data_pegawai->nip?>','riwayat_kepegawaian','')"><i class="glyphicon glyphicon-plus"></i>  Tambah </a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group ">
                        <div class="col-md-3 col-md-offset-5">
                            <a  class="btn btn-primary btn-sm" onclick="profilAjax_send('<?=$data_pegawai->nip?>','data_pasangan','')"><i class="glyphicon glyphicon-plus"></i>  Tambah </a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group ">
                        <div class="col-md-3 col-md-offset-5">
                            <a  class="btn btn-primary btn-sm" onclick="profilAjax_send('<?=$data_pegawai->nip?>','riwayat_jabatan','')"><i class="glyphicon glyphicon-plus"></i>  Tambah </a>
                        </div>
                    </div>
                </form>
            </div>
