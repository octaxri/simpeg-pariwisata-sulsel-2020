                        ...
                        <?php if ($riwayat_angkakredit_notverified != NULL): ?>
                            <?php $i=1; foreach ($riwayat_angkakredit_notverified as $riwayat_angkakredit_notverified): ?>
                                <tr class="data-itemriwayatangkakredit" data-id="<?=$riwayat_angkakredit_notverified->id_riwayat?>">
                                    ...
                                    <td align="center">
                                        <a style="" onclick="isVerified('yes', '<?=$riwayat_angkakredit_notverified->id_riwayat?>')" class="btn btn-primary btn-xs"><i class="fa fa-check-circle-o"></i></a>
                                        <a style="" onclick="isVerified('no','<?=$riwayat_angkakredit_notverified->id_riwayat?>');" class="btn btn-danger btn-xs"><i class="fa fa-times-circle"></i></a>
                                    </td>
                                </tr>
                            <?php $i++; endforeach;?>
                        <?php endif;?>
